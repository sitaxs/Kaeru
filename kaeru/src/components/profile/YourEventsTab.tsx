  ...
  return (
    <div className="animate-in fade-in duration-300 w-full">
      <div className="flex gap-2 md:gap-4 mb-6 overflow-x-auto hide-scrollbar pb-2">
        ...
        <button onClick={() => setSubTab("inactive")} className={`px-5 py-2 rounded-full text-sm font-medium whitespace-nowrap transition-colors ${subTab === "inactive" ? "bg-orange-100 text-orange" : "bg-gray-100 text-gray-500 hover:bg-gray-200"}`}>Минулі події</button>
      </div>
